        ...
        <el-scrollbar wrap-class="scrollbar-wrapper">
            ...
            >
                ...
                <!-- <el-submenu index="/home">
                  ...
                  <el-menu-item index="1-4-1">首页banner</el-menu-item>
                  <el-menu-item index="1-4-1">每周主推</el-menu-item>
                  <el-menu-item index="1-4-1">区域特返</el-menu-item>
                  <el-menu-item index="1-4-1">云超直供</el-menu-item>
