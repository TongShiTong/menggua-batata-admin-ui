  ...
  <div class="app-container">
      <div class="home-box">
          ...
          <div class="img-box">
              ...
              <div>
                  <el-button size="mini" round icon="el-icon-arrow-top">上一页</el-button>
                  <el-button size="mini" round icon="el-icon-arrow-bottom">上一页</el-button>
                  <el-button size="mini" round icon="el-icon-delete">上一页</el-button>
              </div>
          </div>
      </div>
