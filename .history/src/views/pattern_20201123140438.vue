  ...
  export default {
    ...
    methods: {
      ...
      async getequityBylevelId(levelId){
        this.resetEquity()
        // this.$nextTick(()=>{
           console.log(11144,this.$refs.levelEquitylRef)
      ...
      async getWhereBylevelId(levelId){
        this.resetLevelSep()
        this.$nextTick(()=>{
          console.log(11146,this.$refs.levelEquitylRef)
      ...
      LevelCreate() {
        ...
        this.$nextTick(()=>{
          console.log(11145,this.$refs.levelEquitylRef)
      ...
      resetForm(formName) {
        if (this.$refs[formName]!==undefined) {
          console.log(11155,this.$refs[formName])
