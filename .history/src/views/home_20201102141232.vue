  ...
  <div class="app-container">
      <div class="home-box">
          ...
          <div class="img-box">
              ...
              <div class="btns-box">
                  <div style="line-height:24px;" class="btn-item el-icon-arrow-up"></div>
                  <div style="line-height:24px;" class="btn-item el-icon-arrow-down"></div>
                  <div style="line-height:24px;" class="btn-item el-icon-close"></div>
              </div>
          </div>
      </div>
