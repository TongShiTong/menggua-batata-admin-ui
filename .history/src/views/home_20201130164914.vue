<template>
  <div class="app-containers-box">
    <div class="home-box" style="padding: 20px 0;">
      <div class="title-item" style="padding: 0 20px;">首页banner(718*200)</div>
      
      <div style="max-height: 65vh;overflow-y: auto;padding: 0 20px;">
      ...
      <div class="add-banner" style="margin: 0 auto;" @click="addBanner">
        添加
      </div>
      <div class="save-btn">
    ...
    <div class="home-box">
      ...
      <div style="max-height: 30vh;overflow-y: auto;padding: 10px 20px 0;">
      <div
