              ...
              <div class="data-box1">
                  <div v-for="(item, index) in dataList" :key="index">
                    ...
                    <div v-for="(item1, index1) in item.city" :key="index1">
                      ...
                      <div v-for="(item2, index2) in areaList" :key="index2" class="area-box" :class="[provIndex===index&&cityIndex===index1?'active1':'disActive1']" @click="bindArea(index,index1,index2)">
