<template>
  <div class="app-container">
    ...
    <!-- 用户详情对话弹框 -->
    <el-dialog title="模式名称+业绩详情" :model="sales" :visible.sync="yjiVisible" width="60%" style="padding-top: 0;">
      <!-- 详情页头部-->
      <div class="filter-container" style="display: flex;align-items: center;">
        <!-- <el-image style="width: 50px; height: 50px"></el-image> -->
        <img :src="sales.avatarUrl" style="width: 50px; height: 50px;margin-right:10px">
