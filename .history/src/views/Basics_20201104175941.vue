    ...
    <el-card class="box-card">
      <div class="fenhong-info">
        <div class="home-box">
            ...
            <div class="pt-bt">
                <div>全平台补贴</div>
                <div><input type="text" placeholder="0" @input="upInput4" v-model="input4">%</div>
            </div>
            <div class="data-box">
                <div class="pt-bt1">
              ...
              <div class="data-box1">
                  <div v-for="(item, index) in dataList" :key="index">
                    ...
                    <div v-for="(item1, index1) in item.city" :key="index1">
                      <div class="province-box" style="margin-left: 50px;" v-bind:title="item1.shiList" @click="bindCity(index,index1)">{{item1.shiList}}</div>
                      <div v-for="(item2, index2) in item1.area" :key="index2" class="area-box" :class="[provIndex===index&&cityIndex===index1?'active1':'disActive1']" @click="bindArea(index,index1,index2)">
                        <div class="area" v-bind:title="item2.name">{{item2.name}}</div>
                        <div class="input-box">
                          <input type="text" v-model="item2.actualScale" />%
                        </div>
                        <div class="input-box">
                          <input type="text" v-model="item2.getScale" disabled/>%
                        </div>
                        <div class="input-box">
                          <input type="text" v-model="item2.regionScale" />%
                        </div>
                        <div class="input-box">
                          <input type="text" v-model="item2.supplementScale" disabled/>%
                        </div>
                        <div class="gs-times" style="width:200px">
                          <input type="text" placeholder="姓名" v-model="item2.regionName" style="width:40%;text-align:right;background:none;">
                          <input type="text" placeholder="编号" v-model="item2.regionNum" style="width:40%;text-align:left;background:none;">
  ...
  methods: {
      ...
      async getArea(id) {
        ...
        if(res.code=="801") {
          ...
          this.dataList[this.provIndex].city[this.cityIndex].area = res.result
