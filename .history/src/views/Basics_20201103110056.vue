      ...
      <el-card class="box-card">
        <div class="todo-box">
            <div>
                ...
                <div class="draw">
                    <span>商品佣金 <el-input v-model="input" placeholder="30"></el-input> %</span>
                    <span>区域分红 <el-input v-model="input" placeholder="30"></el-input> %</span>
                    <span>平台剩余 <el-input v-model="input" placeholder="30"></el-input> %</span>
