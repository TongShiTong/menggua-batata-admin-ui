    ...
    <el-card class="box-card">
      <div class="fenhong-info">
        <div class="home-box">
            ...
            <div class="pt-bt">
                <div>全平台补贴</div>
                <div><input type="text" placeholder="0" @blur="upInput4" v-model="input4">%</div>
            </div>
            <div class="data-box">
                <div class="pt-bt1">
                      ...
                      <div v-for="(item1, index1) in item.city" :key="index1">
                        ...
                        <div v-if="provIndex===index&&cityIndex1===index1">
                          <div v-for="(item2, index2) in areaList" :key="index2" class="area-box"  @click="bindArea(index2)">
                            ...
                            <div class="input-box">
                              <input type="text" placeholder="0" @blur="actualScale" v-model="item2.actualScale" />%
                            </div>
                            <div class="input-box">
                              <input type="text" placeholder="0" v-model="item2.getScale" disabled/>%
                            </div>
                            <div class="input-box">
                              <input type="text" placeholder="0" @blur="regionScale" v-model="item2.regionScale" />%
                            </div>
                            <div class="input-box">
                              <input type="text" placeholder="0" v-model="item2.supplementScale" disabled/>%
                            </div>
                            <div class="gs-times" style="width:200px">
                              <input type="text" placeholder="姓名" @blur="regionName" v-model="item2.regionName" style="width:40%;text-align:right;background:none;">
                              <input type="text" placeholder="编号" @blur="regionNum" v-model="item2.regionNum" style="width:40%;text-align:left;background:none;">
                            </div>
