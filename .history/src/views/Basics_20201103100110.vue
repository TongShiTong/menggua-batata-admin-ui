<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="queryInfo.state" placeholder="筛选条件" clearable style="width: 100px" class="filter-item">
    ...
    <!-- 用户详情对话弹框 -->
    <el-dialog title="用户详情" :visible.sync="detailFormVisible" width="30%">
