<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="queryInfo.userType" placeholder="选择模式" class="filter-item" clearable style="width: 100px;">
      ...
      <el-select v-model="queryInfo.condition" placeholder="排序条件" style="width: 100px" class="filter-item" clearable>
    ...
    <el-table :data="salesList" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="操作" align="center" min-width="80px" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-button size="small" type="success" @click="getSales(row.jobId)">
            详情
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="模式名称+业绩详情" :model="sales" :visible.sync="yjiVisible" width="60%">
      ...
      <div class="filter-container">
        ...
        <span style="font-size: medium;">{{sales.userName}}</span>
        <span>{{sales.jobId}}</span>
      ...
      <el-table :data="salesDate" style="width: 100%;">
        <el-table-column label="用户运营业绩" min-width="100px" align="center">
          <template slot-scope="{row}">
            <span>用户运营</span>
          </template>
        </el-table-column>
      ...
      <br />
      <el-table :data="salesDate" style="width: 100%;">
        <el-table-column label="商品销售业绩" min-width="100px" align="center">
          <template slot-scope="{row}">
            <span>用户运营</span>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async getSalesList() {
        ...
        console.log(res.result.sales.records)
