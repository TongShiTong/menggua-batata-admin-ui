...
<!-- v-loading="listLoading" el-table加载属性-->
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
					<el-button type="primary" size="small" :disabled="row.patternStatus===0?false:true" @click="handleUpdate(row)">编辑</el-button>
					<el-button type="danger" size="small" :disabled="row.patternStatus===0?false:true" @click="handleDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
