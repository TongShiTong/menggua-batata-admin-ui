    ...
    <div class="home-box">
      ...
      <div v-for="(item, index) in bannerList" :key="index" class="item-banner">
        <div class="img-box">
          ...
          <div class="btns-box">
            <div style="line-height: 20px" class="btn-item el-icon-arrow-up" @click="upImg(index)"></div>
            <div style="line-height: 20px" class="btn-item el-icon-arrow-down" @click="downImg(index)"></div>
            <div style="line-height: 20px" class="btn-item el-icon-close" @click="deleteBanner(index)"></div>
          </div>
        </div>
        <div class="input-box">
          <el-input
      ...
      <div class="add-btn">
          <el-button type="primary" size="small" round @click="addBanner">添加</el-button>
      </div>
      <div class="save-btn">
          ...
          <div class="img-upload">
            ...
            >
              ...
              <div
                ...
                :style="{ backgroundImage: 'url(' + weekly.banner_info.img_url + ')' }"
                class="avatar"
              />
              <i v-else class="el-icon-plus avatar-uploader-icon" />
            </el-upload>
