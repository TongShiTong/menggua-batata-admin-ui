            ...
            <div class="info-cont">
              ...
              <div class="data-box1">
                  <div v-for="(item, index) in dataList" :key="index">
                    <div class="province-box" @click="bindProv(index)">{{item.shengList}}</div>

                    <div ref="content" :class="[provIndex===index?'active':'disActive']">
                    <div v-for="(item1, index1) in item.city" :key="index1">
                      <div class="province-box" style="margin-left: 50px;" @click="bindCity(index,index1)">{{item1.shiList}}</div>
