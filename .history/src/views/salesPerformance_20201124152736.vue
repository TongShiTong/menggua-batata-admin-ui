  ...
  <div class="app-container">
    ...
    <el-dialog title="模式名称+业绩详情" :model="sales" :visible.sync="yjiVisible" width="60%">
      ...
      <el-table :data="salesDate[0].salesItemVOS" style="width: 100%;">
        ...
        <el-table-column label="商品名称" min-width="90px" align="center">
          <template slot-scope="{row}">
            <span>{{row.title}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="订单数" min-width="90px" align="center">
          <template slot-scope="{row}">
        ...
        <el-table-column label="销售排名" min-width="90px" align="center">
          <template slot-scope="{row}">
