    ...
    async saveItem(type) {
      ...
      if(type===1) {
       ...
       data.str = this.bannerList
        ...
        let ids = []
        console.log(333,this.weekly.list)
        for(let i=0; i<this.weekly.list; i++) {
          console.log(444,this.weekly.list[i].itemId)
          ids.push(this.weekly.list[i].itemId)
        }
        ...
        let ids = []
        for(let i=0; i<this.region.list; i++) {
          ids.push(this.region.list[i].itemId)
        }
        data.classification = type
        ...
        let ids = []
        for(let i=0; i<this.cloud.list; i++) {
          ids.push(this.cloud.list[i].itemId)
        }
        data.classification = type
