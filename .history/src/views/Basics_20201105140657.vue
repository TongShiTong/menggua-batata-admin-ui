                    ...
                    <div ref="element" :class="[provIndex===index ? 'active':'disActive']">
                      <div v-for="(item1, index1) in item.city" :key="index1">
                        ...
                        <div v-if="provIndex===index&&cityIndex1===index1">
                          <div v-for="(item2, index2) in areaList" :key="index2" class="area-box"  @click="bindArea(index,index1,index2)">
                            <div class="area" v-bind:title="item2.name">{{item2.name}}</div>
                            <div class="input-box">
                              <input type="text" placeholder="0" v-model="item2.actualScale" />%
                            </div>
                            <div class="input-box">
                              <input type="text" placeholder="0" v-model="item2.getScale" disabled/>%
                            </div>
                            <div class="input-box">
                              <input type="text" placeholder="0" v-model="item2.regionScale" />%
                            </div>
                            <div class="input-box">
      ...
      async getArea(id) {
        ...
        if(res.code=="801") {
          ...
          for(let i=0; i<res.result.length; i++) {
            res.result[i].allTime.push(res.result[i].startTime)
            res.result[i].allTime.push(res.result[i].endTime)
          }
