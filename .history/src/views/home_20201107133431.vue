<template>
  <div class="app-containers-box">
    ...
    <div class="home-box">
      ...
      <div class="add-banner1" @click="addGood(1)" v-if="weekly.list.length<4">
        添加
      </div>
      <div class="save-btn">
    ...
    <div class="home-box">
      ...
      <div class="add-banner1" @click="addGood(2)" v-if="region.list.length<4">
        添加
      </div>
      <div class="save-btn">
    ...
    <div class="home-box">
      ...
      <div class="add-banner1" @click="addGood(3)" v-if="cloud.list.length<4">
        添加
      </div>
      <div class="save-btn">
...
export default {
  ...
  methods: {
    ...
    AllsureSelect(item) {
      console.log(item)
      console.log(5588,this.all_dataList)
