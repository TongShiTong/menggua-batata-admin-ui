            ...
            <div class="info-cont">
              ...
              <div class="data-box1">
                  <div v-for="(item, index) in dataList" :key="index">
                    ...
                    <div v-for="(item1, index1) in item.city" :key="index1" :class="[provIndex===index?'active':'disActive']">
                      <div class="province-box" style="margin-left: 50px;">{{item1.city}}</div>
                      <div v-for="(item2, index2) in item1.area" :key="index2" class="area-box">
