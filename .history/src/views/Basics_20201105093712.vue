            ...
            <div class="info-cont">
              ...
              <div class="data-box1">
                  <div v-for="(item, index) in dataList" :key="index">
                    ...
                    <div ref="content" :class="[provIndex1===index?'active':'disActive']">
                    <div v-for="(item1, index1) in item.city" :key="index1" :class="[cityIndex1===index1?'active1':'disActive1']">
  ...
  methods: {
      ...
      async getArea(id) {
        ...
        if(res.code=="801") {
          ...
          this.provIndex1 = this.provIndex
          this.cityIndex1 = this.provIndex
