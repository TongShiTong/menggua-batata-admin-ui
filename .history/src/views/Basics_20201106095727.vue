                      ...
                      <div v-for="(item1, index1) in item.city" :key="index1">
                        ...
                        <div v-if="provIndex===index&&cityIndex1===index1">
                          <div v-for="(item2, index2) in areaList" :key="index2" class="area-box"  @click="bindArea(index2)">
                            ...
                            <div class="input-box">
                              <input type="number" placeholder="0" onkeypress="if(window.event.keyCode==13) this.blur()" @blur="actualScale" v-model="item2.actualScale" />%
                            </div>
                            <div class="input-box">
                              <input type="number" placeholder="0" v-model="item2.getScale" disabled/>%
                            </div>
                            <div class="input-box">
                              <input type="number" placeholder="0" onkeypress="if(window.event.keyCode==13) this.blur()" @blur="regionScale" v-model="item2.regionScale" />%
                            </div>
                            <div class="input-box">
                              <input type="number" placeholder="0" v-model="item2.supplementScale" disabled/>%
                            </div>
